 ...
 */
export const getRefsOrMentions = (markdown, quantifier = "#") => {
  let regex = REFERENCE_REGEX;
  if (quantifier === "@") regex = MENTION_REGEX;

  let matched = markdown
    .match(regex)
    .map(ref => ref.replace(quantifier, "").trim())
 ...
 */
export const parseRefsAndMentions = markdown => {
  return markdown
...
export const toggleArrayItem = (arr, value) => {
...
// TODO: improve algo
export const calculateReputation = reactions => {
